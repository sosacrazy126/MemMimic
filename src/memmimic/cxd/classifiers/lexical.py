...
class LexicalCXDClassifier(CXDClassifier):
    ...
    def _analyze_function(
        self, text: str, function: CXDFunction
    ...
    def _create_tags(
        ...
        evidence_by_function: Dict[CXDFunction, List[str]],
    ) -> List[CXDTag]:
        """
    ...
    def _update_stats(
        self, function_scores: Dict[CXDFunction, float], processing_time: float
    ) -> None:
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        if total_classifications > 0:
            ...
            for function, count in self.stats["function_detections"].items():
                detection_rates[f"{function.value}_detection_rate"] = (
