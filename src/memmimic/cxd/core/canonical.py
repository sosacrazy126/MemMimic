...
class CanonicalExample:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"CanonicalExample(id='{self.id}', function={self.function.name}, "
...
class CanonicalExampleSet:
    ...
    def filter_by_quality(self, min_quality: float) -> "CanonicalExampleSet":
        ...
        """
        filtered_examples = [
            ex for ex in self.examples if ex.quality_score >= min_quality
        ]
    ...
    ) -> List[tuple[CanonicalExample, CanonicalExample, float]]:
        """
    ...
    def validate_set(self) -> Dict[str, Any]:
        ...
        if low_quality:
            report["warnings"].append(
                f"{len(low_quality)} low quality examples (< 0.5)"
            )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "statistics": {
                "function_counts": {
                    f.value: count for f, count in self.function_counts.items()
                },
