...
class CXDTag:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"CXDTag({self.function.name}, {self.state.name}, "
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            abs(self.confidence - other.confidence) < 1e-7
            and abs(self.semantic_confidence - other.semantic_confidence) < 1e-7
            and
        ...
        )  # También puede ser demasiado estricto
...
class CXDSequence:
    ...
    def filter_by_state(
        self, states: Union[ExecutionState, List[ExecutionState]]
    ) -> "CXDSequence":
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "dominant_function": (
                self.dominant_function.value if self.dominant_function else None
            ),
    ...
    def __post_init__(self):
        ...
        for key, value in self.confidence_scores.items():
            if not 0.0 <= value <= 1.0:
                raise ValueError(
                    f"Confidence score '{key}' must be between 0.0 and 1.0"
                )
    ...
    def get_detailed_analysis(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "lexical_analysis": {
                ...
                "dominant": (
                    self.lexical_sequence.dominant_function.value
                    if self.lexical_sequence.dominant_function
                    else None
                ),
            ...
            "semantic_analysis": {
                ...
                "dominant": (
                    self.semantic_sequence.dominant_function.value
                    if self.semantic_sequence.dominant_function
                    else None
                ),
            ...
            "meta_analysis": {
                ...
                "delta_semantic_final": self.semantic_sequence.delta(
                    self.final_sequence
                ),
                "processing_time_ms": self.processing_time_ms,
            },
...
def merge_sequences(
    sequences: List[CXDSequence], weights: Optional[List[float]] = None
) -> CXDSequence:
    """
