...
from .types import CXDFunction, CXDSequence, MetaClassificationResult
...
class CXDClassifier(ABC):
    ...
    def supports_batch(self) -> bool:
        ...
        return self.__class__.classify_batch != CXDClassifier.classify_batch
...
class CanonicalExampleProvider(ABC):
    ...
    def get_examples_for_function(
        self, function: CXDFunction
...
class MetricsCollector(ABC):
    ...
    def record_classification(
        self, text: str, result: CXDSequence, processing_time: float
    ) -> None:
        """
