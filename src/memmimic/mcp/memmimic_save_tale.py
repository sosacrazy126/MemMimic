...
def update_existing_tale(tale_manager, name, content, category, existing_tale, tags=None):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="MemMimic Save Tale - Auto-Detect Create/Update")
