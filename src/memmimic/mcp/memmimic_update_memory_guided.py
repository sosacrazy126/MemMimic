...
def main():
    ...
    try:
        ...
        result_parts.append("4. Use delete_memory_guided() to remove old version if needed")
        result_parts.append("")
        result_parts.append("📝 EXAMPLE UPDATE PROCESS:")
        result_parts.append("  remember('Enhanced: [your improved content]', 'interaction')")
        result_parts.append(f"  delete_memory_guided({args.memory_id}, confirm=True)")
        result_parts.append("")
        
        # Related actions
        result_parts.append("🔗 RELATED ACTIONS:")
        result_parts.append("  socratic_dialogue('memory_topic')     # Deep questioning")
        result_parts.append("  analyze_memory_patterns()             # Pattern analysis")
        result_parts.append("  context_tale('memory_context')        # Generate narrative")
        result_parts.append("")
