...
def main():
    ...
    try:
        ...
        if not args.confirm:
            ...
            preview = tale_content[:200] + "..." if len(tale_content) > 200 else tale_content
            print(f"   {preview}")
            print("")
        ...
        result = tale_manager.delete_tale(
            ...
            hard=False  # Soft delete for safety
        )
        ...
        success_parts.append(f"  save_tale('{tale_name}', 'content')  # Recreate if needed")
