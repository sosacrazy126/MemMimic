...
from ..config import get_config, MemMimicConfig
...
class UnifiedMemoryStore:
    ...
    def search(self, query: str, limit: int = 5) -> List[Memory]:
        ...
        try:
            ...
            self.logger.debug(f"AMMS search returned {len(memories)} results for: {query}")
            return memories
    ...
    def search_with_ranking(self, query: str, limit: int = 10, 
        ...
        try:
            ...
            return [{"content": m.content, "type": m.type, "confidence": m.confidence, 
                    "id": getattr(m, 'id', 0), "score": 0.5} for m in basic_results]
