...
class ActiveMemorySchema:
            ...
            if cursor.fetchone():
                ...
                for memory in memories:
                    ...
                    """, (
                        ...
                        memory['created_at'],
                        memory['access_count'],
                        memory['created_at'],  # Use created_at as initial last_access
                        initial_importance,
    ...
    def _calculate_initial_importance(self, confidence: float, memory_type: str, access_count: int) -> float:
    ...
    def get_schema_info(self) -> Dict[str, Any]:
        ...
        with self._get_connection() as conn:
            # Get schema version
            cursor = conn.execute("SELECT * FROM schema_version ORDER BY applied_at DESC LIMIT 1")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("Schema Info:")
        print(f"  Version: {info['schema_version']['version'] if info['schema_version'] else 'None'}")
